...
CustomProcessor::CustomProcessor()
    : GenericProcessor ("CustomProcessor")
{
...
void CustomProcessor::setParameter (int parameterIndex, float newValue)
{
...
void CustomProcessor::process (AudioSampleBuffer& buffer)
{
