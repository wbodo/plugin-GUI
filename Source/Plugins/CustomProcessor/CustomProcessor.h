...
#ifndef CUSTOMPROCESSOR_H_INCLUDED
#define CUSTOMPROCESSOR_H_INCLUDED
...
/** A simple CustomProcessor */
class CustomProcessor : public GenericProcessor
{
public:
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomProcessor);
};



#endif  // CUSTOMPROCESSOR_H_INCLUDED
